...
\begin{frame}
  ...
  \begin{columns}{T}
    ...
    \end{itemize}
    \column{.5\textwidth}
    \only<1>{\includegraphics[width=.9\linewidth]{board-view.png}}
    \only<2>{\includegraphics[width=.9\linewidth]{table-view.png}}
  \end{columns}
\end{frame}
...
\begin{frame}
  ...
  \end{itemize}
  \column{.5\textwidth}
    \only<1>{\includegraphics[width=.9\linewidth]{issues-1.png}}
    \only<2>{\includegraphics[width=.9\linewidth]{issues-2.png}}
    \only<3>{\includegraphics[width=.9\linewidth]{issues-3.png}}
  \end{columns}
\end{frame}
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \column{.45\textwidth}
    \includegraphics[width=.9\linewidth]{conversations-1.png}
  \end{columns}
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \end{itemize}
    \column{.55\textwidth}
    \only<1>{\includegraphics[width=.95\linewidth]{views-1.png}}
    \only<2>{\includegraphics[width=.95\linewidth]{views-2.png}}
    \only<3>{\includegraphics[width=.95\linewidth]{views-3.png}}
  \end{columns}
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \end{itemize}
    \column{.55\textwidth}
    \only<1>{\includegraphics[width=.95\linewidth]{custom-fields-1.png}}
    \only<2>{\includegraphics[width=.95\linewidth]{custom-fields-2.png}}
  \end{columns}
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \end{itemize}
    \column{.55\textwidth}
    \only<1>{\includegraphics[width=.95\linewidth]{charts-1.png}}
  \end{columns}
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \end{itemize}
    \column{.55\textwidth}
    \only<1>{\includegraphics[width=.95\linewidth]{workfflows-1.png}}
  \end{columns}
